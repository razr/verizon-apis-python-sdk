...
class PayAsYouGoCreateTriggerRequest(object):

    """Implementation of the 'payAsYouGoCreateTriggerRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PayAsYouGoCreateTriggerRequest class"""
