...
class AccountGroupShareUpdateTrigger(object):

    """Implementation of the 'accountGroupShareUpdateTrigger' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AccountGroupShareUpdateTrigger class"""
