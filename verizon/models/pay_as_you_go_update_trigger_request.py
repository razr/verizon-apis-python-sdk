...
class PayAsYouGoUpdateTriggerRequest(object):

    """Implementation of the 'payAsYouGoUpdateTriggerRequest' model.
    ...
    Attributes:
        ...
        trigger_category (TriggerCategoryEnum): The type of trigger being
            created or modified
        price_plan_trigger (PayAsYouGoPricePlanTrigger): The model property of
    ...
    def __init__(self,
        ...
        """Constructor for the PayAsYouGoUpdateTriggerRequest class"""
    ...
    def from_dictionary(cls,
        ...
        price_plan_trigger = PayAsYouGoPricePlanTrigger.from_dictionary(dictionary.get('pricePlanTrigger')) if 'pricePlanTrigger' in dictionary.keys() else APIHelper.SKIP
