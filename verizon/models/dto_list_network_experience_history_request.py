...
class DtoListNetworkExperienceHistoryRequest(object):

    """Implementation of the 'dto.ListNetworkExperienceHistoryRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DtoListNetworkExperienceHistoryRequest class"""
