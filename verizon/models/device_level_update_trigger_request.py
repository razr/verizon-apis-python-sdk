...
class DeviceLevelUpdateTriggerRequest(object):

    """Implementation of the 'deviceLevelUpdateTriggerRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DeviceLevelUpdateTriggerRequest class"""
