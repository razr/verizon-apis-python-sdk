...
class ChangePWNDeviceStateResponse(object):

    """Implementation of the 'ChangePWNDeviceStateResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ChangePWNDeviceStateResponse class"""
