...
class ChangePWNDeviceIpaddressResponse(object):

    """Implementation of the 'ChangePWNDeviceIPAddressResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ChangePWNDeviceIpaddressResponse class"""
