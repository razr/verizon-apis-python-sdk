...
class V2TriggersRequest1(object):

    """Implementation of the 'V2 Triggers Request1' model.
    ...
    Attributes:
        ...
        trigger_category (TriggerCategoryEnum): The type of trigger being
            created or modified
        data_trigger (DataTrigger5): The model property of type DataTrigger5.
        ...
        account_name (str): The numeric name of the account and must include
            leading zeroes
        price_plan_trigger (PricePlanTrigger2): The model property of type
            PricePlanTrigger2.
    ...
    def __init__(self,
        ...
        """Constructor for the V2TriggersRequest1 class"""
    ...
    def from_dictionary(cls,
        ...
        data_trigger = DataTrigger5.from_dictionary(dictionary.get('dataTrigger')) if 'dataTrigger' in dictionary.keys() else APIHelper.SKIP
        ...
        price_plan_trigger = PricePlanTrigger2.from_dictionary(dictionary.get('pricePlanTrigger')) if 'pricePlanTrigger' in dictionary.keys() else APIHelper.SKIP
