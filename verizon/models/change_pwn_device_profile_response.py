...
class ChangePWNDeviceProfileResponse(object):

    """Implementation of the 'ChangePWNDeviceProfileResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ChangePWNDeviceProfileResponse class"""
