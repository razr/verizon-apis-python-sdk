...
class AccountLevelCreateTriggerRequest(object):

    """Implementation of the 'accountLevelCreateTriggerRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AccountLevelCreateTriggerRequest class"""
    ...
    def from_dictionary(cls,
        ...
        data_trigger = DataTrigger.from_dictionary(dictionary.get('dataTrigger')) if 'dataTrigger' in dictionary.keys() else APIHelper.SKIP
