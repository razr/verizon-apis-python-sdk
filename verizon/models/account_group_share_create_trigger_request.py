...
class AccountGroupShareCreateTriggerRequest(object):

    """Implementation of the 'accountGroupShareCreateTriggerRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AccountGroupShareCreateTriggerRequest class"""
