...
class AccountGroupShareIndividual1(object):
    ...
    Attributes:
        account_group_share_individual (AccountGroupShareFilterCriteria): The
            model property of type AccountGroupShareFilterCriteria.
    ...
    def __init__(self,
        ...
        """Constructor for the AccountGroupShareIndividual1 class"""
    ...
    def from_dictionary(cls,
        ...
        account_group_share_individual = AccountGroupShareFilterCriteria.from_dictionary(dictionary.get('accountGroupShareIndividual')) if 'accountGroupShareIndividual' in dictionary.keys() else APIHelper.SKIP
