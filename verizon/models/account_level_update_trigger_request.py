...
class AccountLevelUpdateTriggerRequest(object):

    """Implementation of the 'accountLevelUpdateTriggerRequest' model.
    ...
    Attributes:
        ...
        trigger_category (TriggerCategoryEnum): The type of trigger being
            created or modified
        data_trigger (DataTrigger1): The model property of type DataTrigger1.
    ...
    def __init__(self,
        ...
        """Constructor for the AccountLevelUpdateTriggerRequest class"""
    ...
    def from_dictionary(cls,
        ...
        data_trigger = DataTrigger1.from_dictionary(dictionary.get('dataTrigger')) if 'dataTrigger' in dictionary.keys() else APIHelper.SKIP
