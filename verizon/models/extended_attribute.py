...
class ExtendedAttribute(object):
    ...
    """Implementation of the 'ExtendedAttribute' model.

    Attributes:
        key (str): The key indicates if the SMS message was to the device
            (MtSms) or from the device (MoSms)
        value (str): The number of SMS messages found
    ...
    def __init__(self,
        ...
        """Constructor for the ExtendedAttribute class"""
