...
class ESIMGlobalDeviceList(object):
    ...
    Attributes:
        ...
        provisioning_status_filter (ProvisioningStatusFilterEnum): The last
            status of the device as a list filter.
        profile_status_filter (ProfileStatusFilterEnum): The last status of
            the device's profile as a filter.
        carrier_name_filter (str): The cellular service provider.
        device_filter (List[DeviceId2]): An array of device identifiers to
            filter the list.
    ...
    def __init__(self,
        ...
        """Constructor for the ESIMGlobalDeviceList class"""
