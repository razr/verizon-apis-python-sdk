...
class AccountShareCreateTriggerRequest(object):

    """Implementation of the 'accountShareCreateTriggerRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AccountShareCreateTriggerRequest class"""
