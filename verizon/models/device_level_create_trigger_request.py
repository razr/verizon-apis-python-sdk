...
class DeviceLevelCreateTriggerRequest(object):

    """Implementation of the 'deviceLevelCreateTriggerRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DeviceLevelCreateTriggerRequest class"""
