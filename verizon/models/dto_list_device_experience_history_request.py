...
class DtoListDeviceExperienceHistoryRequest(object):

    """Implementation of the 'dto.ListDeviceExperienceHistoryRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DtoListDeviceExperienceHistoryRequest class"""
