...
class MultiLineString(object):
    ...
    """Implementation of the 'MultiLineString' model.

    A MultiLineString is a type of geometry that represents a collection of
    LineString geometries.

    Attributes:
        mtype (MultiLineStringTypeEnum): The model property of type
