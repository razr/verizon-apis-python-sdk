...
class CreatePricePlanTriggersController(BaseController):

    """A Controller to access Endpoints in the verizon API."""
    def __init__(self, config):
        super(CreatePricePlanTriggersController, self).__init__(config)
    ...
    def create_trigger_rules(self,
        ...
        Args:
            body (V2TriggersRequest): Create a trigger
