...
class SensorInsightsNotificationGroupsController(BaseController):

    """A Controller to access Endpoints in the verizon API."""
    def __init__(self, config):
        super(SensorInsightsNotificationGroupsController, self).__init__(config)

    def sensor_insights_list_notification_group_request(self,
                                                        body):
        """Does a POST request to /dm/v1/notificationGroups/actions/query.

        Args:
            body (DtoListNotificationGroupRequest): Retrieve a notification
                group
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(DtoNotificationGroupResponseEntity.from_dictionary)
    ...
    def sensor_insights_update_notification_group_request(self,
                                                          body):
        """Does a PATCH request to /dm/v1/notificationGroups.

        Args:
            body (DtoUpdateNotificationGroupRequest): Partially update a
                notification group
    ...
    def sensor_insights_create_notification_group_request(self,
                                                          body):
        """Does a POST request to /dm/v1/notificationGroups.

        Args:
            body (DtoCreateNotificationGroupRequest): Create a notification
                group
    ...
    def sensor_insights_delete_notification_group(self,
                                                  payload):
        """Does a DELETE request to /dm/v1/notificationGroups.

        Args:
            payload (DtoDeleteNotificationGroupRequest): Payload for the
                delete request.
    ...
    def sensor_insights_add_users_to_notification_group_request(self,
                                                                body):
        """Does a POST request to /dm/v1/notificationGroups/actions/add-users.

        Args:
            body (DtoAddUsersToNotificationGroupRequest): Add users to a
                notification group
    ...
    def sensor_insights_remove_users_from_notification_group_request(self,
                                                                     body):
        """Does a POST request to /dm/v1/notificationGroups/actions/remove-users.

        Args:
            body (DtoRemoveUsersFromNotificationGroupRequest): Remove users
