...
class SensorInsightsGatewaysController(BaseController):

    """A Controller to access Endpoints in the verizon API."""
    def __init__(self, config):
        super(SensorInsightsGatewaysController, self).__init__(config)

    def sensor_insights_list_gateway_devices_request(self,
                                                     body):
        """Does a POST request to /dm/v1/devices/gateways/actions/query.

        Args:
            body (DtoListDevicesRequest): Get gateway information
