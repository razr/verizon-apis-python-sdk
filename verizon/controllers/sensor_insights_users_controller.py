...
from verizon.models.resource_user import ResourceUser
...
class SensorInsightsUsersController(BaseController):

    """A Controller to access Endpoints in the verizon API."""
    def __init__(self, config):
        super(SensorInsightsUsersController, self).__init__(config)

    def sensor_insights_create_user_request(self,
                                            body):
        """Does a POST request to /dm/v1/users.

        Args:
            body (DtoCreateUserRequest): Create a user profile
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(ResourceUser.from_dictionary)
    ...
    def sensor_insights_delete_user(self,
        ...
        """Does a DELETE request to /dm/v1/users.

        Args:
            deleterequestpayload (DtoDeleteUserRequest): Payload for the
                delete user request.
    ...
    def sensor_insights_update_user_request(self,
                                            body):
        """Does a PATCH request to /dm/v1/users.

        Args:
            body (DtoUpdateUserRequest): Partially update a user profile
    ...
    def sensor_insights_list_user_request(self,
                                          body):
        """Does a POST request to /dm/v1/users/actions/query.

        Args:
            body (DtoListUserRequest): A summary of user profile records on an
                account
