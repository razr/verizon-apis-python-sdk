...
class ThingspaceOauth1(HeaderAuth):
    ...
    def error_message(self):
        ...
        """
        return "ThingspaceOauth1: OAuthToken is undefined or expired."

    def __init__(self, thingspace_oauth_1_credentials, config):
        self._oauth_client_id = thingspace_oauth_1_credentials.oauth_client_id \
            if thingspace_oauth_1_credentials is not None else None
        self._oauth_client_secret = thingspace_oauth_1_credentials.oauth_client_secret \
            if thingspace_oauth_1_credentials is not None else None
        if thingspace_oauth_1_credentials is not None \
                and isinstance(thingspace_oauth_1_credentials.oauth_token, OauthToken):
            self._oauth_token = OauthToken.from_dictionary(
                APIHelper.to_dictionary(thingspace_oauth_1_credentials.oauth_token))
        else:
            self._oauth_token = thingspace_oauth_1_credentials.oauth_token \
                if thingspace_oauth_1_credentials is not None else None
        self._oauth_clock_skew = thingspace_oauth_1_credentials.oauth_clock_skew \
            if thingspace_oauth_1_credentials is not None else None
        self._oauth_token_provider = thingspace_oauth_1_credentials.oauth_token_provider \
            if thingspace_oauth_1_credentials is not None else None
        self._oauth_on_token_update = thingspace_oauth_1_credentials.oauth_on_token_update \
            if thingspace_oauth_1_credentials is not None else None
    ...
    def fetch_token(self, additional_params=None):
        ...
        """
        token = self._o_auth_api.request_token_thingspace_oauth_1(
...
class ThingspaceOauth1Credentials:
    ...
    def clone_with(self, oauth_client_id=None, oauth_client_secret=None,
                   oauth_token=None, oauth_token_provider=None,
