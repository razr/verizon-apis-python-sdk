...
class RuleRestErrorResponseException(APIException):
    def __init__(self, reason, response):
        """Constructor for the RuleRestErrorResponseException class
        ...
        """
        super(RuleRestErrorResponseException, self).__init__(reason, response)
